...
from .asio_config import AsioCfg
...
class Asio(BaseTask):
    ...
    def __init__(self, cfg: AsioCfg, sim_params, physics_engine, sim_device, headless):
        self.cfg = cfg
        ...
        self.action_upper_limits = torch.tensor(
            [2, 2, 2], device=self.device, dtype=torch.float32)
