...
class AsioCfg(BaseConfig):
    ...
    class env:
        ...
        num_actions = 3 #Input an acceleration reference 
        env_spacing = 1
    ...
    class control:
        ...
        """
        controller = "fbx_control" # or "lee_velocity_control" or "lee_attitude_control"
    ...
    class robot_asset:
        file = "{AERIAL_GYM_ROOT_DIR}/resources/robots/asio2/asio2.urdf"
        name = "asio"  # actor name
